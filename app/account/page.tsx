         ...
         <main className="min-h-screen flex justify-center items-center">
            <div className="max-w-2xl gap-4 flex flex-col w-full">
               ...
               <div className="flex md:flex-row flex-col gap-4">
                  <div className="bg-secondary p-8 rounded-lg shadow-sm flex flex-col space-y-2 md:w-1/2 w-full">
                  ...
                  <div className="bg-secondary p-8 rounded-lg shadow-sm w-full md:w-1/2">
                     ...
                     <div className="text-sm flex flex-col space-y-3">
                        ...
                        <button className="underline text-foreground/80 text-sm hover:cursor-pointer hover:brightness-95 active:opacity-95 w-fit">Sign Out</button>
                     </div>
                  </div>
               </div>
               <div className="bg-secondary p-8 rounded-lg shadow-sm space-y-2">
                  ...
                  <div className="flex gap-2">
                     <button className="btn bg-blue-500">Open dashboard</button>
